...
void Game_Play(RenderWindow& window) {
        ...
        Texture background, map, sonictexture, springtexture, blocktexture, traptexture, cointexture;
        ...
        Sprite back, grounds[17], Coin[45];
        ...
        while (window.isOpen())
        {
           ...
           if(player.sonic.getPosition().x>=4400)
               ...
               text.setPosition(player.sonic.getPosition().x - 390, 10);
           }
            //Draw
